	...
	return (
		...
		flex flex-col  xl:flex-row  xl:justify-between items-center justify-center py-10">
			<div className='flex flex-col justify-center items-center'>
				...
				<address className='flex flex-col justify-center items-center text-[#798DD8]'>
					<p className="font-bold text-base font-Nunito  mb-2">215 Clinton Ave</p>
					<p className="font-bold text-base font-Nunito  mb-2">11205 Brooklyn</p>
					<p className="font-bold text-base font-Nunito ">NY</p>
				</address>
			</div>
