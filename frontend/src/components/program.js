...
function Program({ name, description, price }) {
	return (
		<section
			...
			data-aos-offset="350"
			data-delay="200"
			className="pb-[47px] px-[41px] pt-16 bg-white flex flex-col items-center"
		>
			...
			<button
				type="button"
				className="flex items-center justify-center text-pink uppercase text-bold text-sm border border-pink rounded-[10px] py-4  w-[270px] transition-transform transform duration-300  hover:scale-110"
			>
